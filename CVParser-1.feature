...
Angenommen, dass "<Tools>" funktionfähig ist
...
####Wenn ich auf den "Bestätigen" button clicke
####Dann bestätige ich meinen neuen Account
...
Szenario: lebenslauf generieren und editieren

Angenommen, dass ich angemeldet bin
Wenn ich ich mein Linkedin Profil kopieren
...
Dann wird mein Profil ##als ein Lebenslauf ## extrahiert 
...
Angenommen, dass ich mich einarbeiten möchte
